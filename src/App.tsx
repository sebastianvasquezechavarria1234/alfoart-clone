...
function App() {
  ...
  return (
    ...
    >
      ...
      <img src={cloud1} alt="cloud-1" className="absolute top-[6%] max-[800px]:top-[20%] left-[25%] max-[800px]:left-[10%] z-60 w-[20%] max-[800px]:w-[55%] cloud-float" style={{ animationDelay: '-3s' }} />
