...
function App() {
  ...
  return (
    ...
    >
      ...
      <img src={cloud3} alt="cloud-3" className="absolute top-[-15%] right-[-2%] z-60 w-[21%] cloud-float" style={{ animationDelay: '-3s' }} />
      <img src={cloud1} alt="cloud-1" className="absolute top-[10%] left-[25%] z-60 w-[22%] cloud-float" style={{ animationDelay: '-3s' }} />
